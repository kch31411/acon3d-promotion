"""
Django settings for acon3d project.
...
SECRET_KEY = '4z51^#m3u-*$p*!kr+ql)89=m+)^n!==n-0oqgoq&xl1*8rvl@'
...
WSGI_APPLICATION = 'acon3d.wsgi.application'
